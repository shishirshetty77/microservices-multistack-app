...
function Analytics() {
  ...
  const chartData = [
    { name: 'Users', count: analytics?.totalUsers || 0, color: '#00ADD8' },
    { name: 'Products', count: analytics?.totalProducts || 0, color: '#3776AB' },
    { name: 'Orders', count: analytics?.totalOrders || 0, color: '#007396' },
    { name: 'Notifications', count: analytics?.totalNotifications || 0, color: '#339933' },
  ];
      ...
      <div className="panel">
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card" style={{ background: 'linear-gradient(135deg, #339933 0%, #287a28 100%)' }}>
            <div className="stat-value">{analytics?.totalNotifications || 0}</div>
